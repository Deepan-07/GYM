...
const schema = yup.object({
  ...
  operatingOpen: yup.string().nullable(),
...
const stepAllFields = {
  1: ['gymIdPrefix', 'gymName', 'gymEmail', 'gymContact', 'address', 'location', 'gst', 'gymType', 'tagline', 'instagramUrl', 'facebookUrl', 'websiteUrl', 'operatingDays', 'operatingOpen', 'operatingClose', 'password', 'confirmPassword'],
  2: ['name', 'mobileNo', 'mailId'],
  3: ['whatsappNumber', 'phoneNumber', 'gmail'],
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const operatingHours = {
        open: data.operatingOpen || '',
        close: data.operatingClose || ''
      };
          ...
          {step === 1 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div>
                ...
                <input {...register('gymType')} placeholder="E.g. CrossFit, Fitness Studio" className="input-field" />
              </div>
              <div>
                <p className="text-xs text-gray-400 mb-1">Tagline (Optional)</p>
                <input {...register('tagline')} placeholder="Short brand tagline" className="input-field" />
              </div>
              ...
              <div>
                ...
                <input {...register('operatingOpen')} type="time" className="input-field text-gray-300" />
              </div>
              <div>
                <p className="text-xs text-gray-400 mb-1">Closing Time (Optional)</p>
                <input {...register('operatingClose')} type="time" className="input-field text-gray-300" />
              </div>
